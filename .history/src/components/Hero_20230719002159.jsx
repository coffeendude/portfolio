  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} relative inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div className="relative xs:w-auto sm:w-[80%]  max-xs:h-[35%] xs:h-[40%] sm:h-[60%] max-xs:mt-[30%] max-xs:ml-2 xs:ml-1 xs:mt-[30%] sm:mt-auto ml-40 rounded-md">
          <ComputersCanvas />
        </div>

      <div className="absolute xs:bottom-10 bottom-32 w-full max-xs:hidden xs:hidden md:flex justify-center items-center ">
        <a href="#about">
