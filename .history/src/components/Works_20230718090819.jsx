    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        ...
        <div
          ...
          <p className="text-sm items-center m-1">This Doom game engine, a full Python adaptation using Pygame, has been modified by me but originated from <span className="font-bold">Coder</span> <span className="font-bold font-mono text-[#fd6a01]">Space's</span> YouTube. I used pygbag to create a WebAssembly version for browser game operation.</p>
        </div>
