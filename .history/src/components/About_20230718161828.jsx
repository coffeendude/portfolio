  ...
  return (
    <>
      ...
      <motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-4 text-[#d8d0df] text-[17px] max-w-3xl leading-[30px]">
        As a seasoned former cast member with <span className='text-[#ef1c26] font-bold'><a href='https://stomponline.com/'>STOMP</a></span>, I thrive in innovative and collaborative problem-solving. 
