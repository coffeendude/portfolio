import {
  ...
  const experiences = [
    ...
    },
    {
      ...
      points: [
        "Served as the lead developer for a backend feature on a data integration HUNT platform, connecting Redis queues via REST API endpoints. Enabled indexed requests to databases and provided support for new or upgraded DB inputs."
      ],
    },
    {
      title: "Student",
