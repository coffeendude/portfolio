  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} relative inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={styles.heroHeadText}>Hi, <span className='text-[#06d6b3]'>I'm</span> <span className="text-[#fbdf3a]">Andrew</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-[#d8d0df]`}>I'm a Platform and Software Engineer
          </p>
        </div>
      </div>

        <div className="absolute xs:w-[55%] sm:w-[60%] xs:h-[40%] sm:h-80 xs:mt-[25%] max-xs:mt-[30%] xs:ml-[20%] max-xs:ml-1 max-xs-w-[45%] sm:mt-auto ml-40 rounded-md">
          <ComputersCanvas />
        </div>
