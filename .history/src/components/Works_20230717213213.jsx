  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        ...
        <div
          className="flex flex-coljustify-center items-center">
          <h3 className="my-2 justify-center items-center">{name}</h3>
          <p className="text-sm tracking-widest justify-center items-center">{description}</p>
        </div>
