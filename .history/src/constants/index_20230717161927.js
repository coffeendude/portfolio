  ...
  const projects = [
    {
      ...
      description:
        "A complete Doom game engine built in python using pygame. I've made some modifications but the original architecture and design decends from youtube channel Coder Space. I was then able to use Pygbag to compile a webassembly version for the browser.",
      tags: [
        {
          name: "python",
