    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        ...
        <div
          ...
          <p className="text-sm items-center m-1">This Doom game engine, a full Python adaptation using Pygame, has been modified by me but originated from <a href='https://www.youtube.com/channel/UCwe6kcllhainHICL1vnq41g'><span className="font-bold">Coder</span> <span className="font-bold text-[#fd6a01]">Space's</span></a> YouTube. I used pygbag to create a WebAssembly version for browser game operation.</p>
        </div>
