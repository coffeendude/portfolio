...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      <div className="absolute xs:bottom-10 bottom-5 z-50 w-full flex justify-center items-center">
        <a href="#about">
          <div className="w-[35px] h-[64px] rounded-3xl borderborder-secondary flex justify-center items-start p-2"></div>
        </a>
      </div>
