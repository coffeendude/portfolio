  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} relative inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div className="absolute xs:w-[55%] sm:w-[60%] max-xs:brightness-100 max-xs:h-[35%] sm:h-80 xs:mt-[25%] max-xs:mt-[33%] max-xs:ml-8  sm:mt-auto ml-40 rounded-md">
          <ComputersCanvas />
        </div>

      <div className="absolute xs:bottom-10 bottom-32 w-full max-xs:hidden sm:flex justify-center items-center ">
        <a href="#about">
