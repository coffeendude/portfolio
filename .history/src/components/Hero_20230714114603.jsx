    ...
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>As a seasoned former global performer, I excel in innovative and collaborative problem-solving. With expertise in driving business-focused solutions to intricate challenges, I am passionate about delivering cost-effective, efficient, and secure product designs, whether as a Platform Engineer or a Software Developer.</p>
        </div>
      </div>
    </section>
