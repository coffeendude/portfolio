  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} relative inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={styles.heroHeadText}><span className="bg-slate-700 bg-opacity-25 p-2 rounded-lg">Hi, <span className='text-[#06d6b3]'>I'm</span> <span className="text-[#fbdf3a]">Andrew</span></span></h1>
