    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex items-end m-3 card-img_hover flex-col gap-1">
            <div 
            ...
            <div 
              ...
              className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer <span className="bg-slate-700 bg-opacity-25 px-2 rounded-lg">"
            >
              <img 
                src={play}
                alt="play"
